        ...
        <div className="child_main">
          <div className="main_content" data-aos="fade-right" data-aos-offset="300">
            ...
            <div className="button_group">
              ...
              <a href={encodeURIComponent("Kumar's Resume-hackerresume (10).pdf")} download>
  <button className="btn2">
    Resume <i className="fa-solid fa-file-download"></i>
  </button>
</a>
            ...
            <div className="con_info">
              ...
              <div style={{ marginLeft: "20px" }}>
                <h3>+91- 6392098271</h3>
                <h3>kranshu351@gmail.com</h3>
                <h3>Varanasi 221010, India</h3>
              </div>
            </div>
          </div>
